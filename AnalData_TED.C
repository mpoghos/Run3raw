...
//  reader.addFile("/home/flp/data/TED_20211008/readoutSMA3_2021_10_08__08_46_42__.raw");
  reader.addFile("/home/flp/data/TED_20211017/readoutSMA3_2021_10_16__17_56_45__.raw");
...
auto hAmpVsTime = new TH2F("hAmpVsTime", "hAmpVsTime", 150, 0, 1500, 200, 0, 1024);
hAmpVsTime->GetXaxis()->SetTitle("time [ns]");
hAmpVsTime->GetYaxis()->SetTitle("amp [ADC]");

auto hColVsRow_Amp = new TH2F("hColVsRow_Amp", "hColVsRow_Amp", 48, -0.5, 47.5, 24, -0.5, 23.5); 
auto hColVsRow_Acc = new TH2F("hColVsRow_Acc", "hColVsRow_Acc", 48, -0.5, 47.5, 24, -0.5, 23.5); 
...
if(col== 4 && row==23) return false;
if(col== 11 && row==23) return false;
if(col== 29 && row==7) return false;
if(col== 31 && row==7) return false;
if(col== 45 && row==0) return false;
